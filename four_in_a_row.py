...
GAME_SCRIPT_X_LOSES = '4 True True\n' \
                      '0\n' \
                      '1\n' \
                      '0\n' \
                      '1\n' \
...
class FourInARow:
    ...
    Attributes:
    - p1_human: whether player number one is a human
    - p2_human: whether player number two is a human
    - result: the outcome of the game
    - board: grid the game is played on
    - p1_to_play: whether player 1 is playing
